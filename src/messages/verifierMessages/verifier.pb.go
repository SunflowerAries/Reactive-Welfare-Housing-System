...
func (x *HouseApplicationRequest) GetRetry() int32 {
	if x != nil {
		return x.Retry
	}
	return 0
...
func (x *HouseCheckOut) GetRetry() int32 {
	if x != nil {
		return x.Retry
	}
	return 0
...
var file_Reactive_Welfare_Housing_System_src_messages_verifier_proto_rawDesc = []byte{
	...
	0x18, 0x03, 0x20, 0x01, 0x28, 0x05, 0x52, 0x05, 0x52, 0x65, 0x74, 0x72, 0x79, 0x22, 0x1a, 0x0a,
	...
	0x05, 0x52, 0x05, 0x52, 0x65, 0x74, 0x72, 0x79, 0x22, 0x12, 0x0a, 0x10, 0x48, 0x6f, 0x75, 0x73,
