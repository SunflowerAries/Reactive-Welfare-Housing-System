...
type UnqualifiedHouseIDs struct {
...
func (x *UnqualifiedHouseIDs) Reset() {
	*x = UnqualifiedHouseIDs{}
...
func (x *UnqualifiedHouseIDs) String() string {
	return protoimpl.X.MessageStringOf(x)
}

func (*UnqualifiedHouseIDs) ProtoMessage() {}

func (x *UnqualifiedHouseIDs) ProtoReflect() protoreflect.Message {
	mi := &file_Reactive_Welfare_Housing_System_src_messages_property_proto_msgTypes[0]
...
// Deprecated: Use UnqualifiedHouseIDs.ProtoReflect.Descriptor instead.
func (*UnqualifiedHouseIDs) Descriptor() ([]byte, []int) {
	return file_Reactive_Welfare_Housing_System_src_messages_property_proto_rawDescGZIP(), []int{0}
}

func (x *UnqualifiedHouseIDs) GetHouseID() []int32 {
	if x != nil {
		return x.HouseID
	}
	return nil
...
var file_Reactive_Welfare_Housing_System_src_messages_property_proto_rawDesc = []byte{
	...
	0x2f, 0x0a, 0x13, 0x55, 0x6e, 0x71, 0x75, 0x61, 0x6c, 0x69, 0x66, 0x69, 0x65, 0x64, 0x48, 0x6f,
	0x75, 0x73, 0x65, 0x49, 0x44, 0x73, 0x12, 0x18, 0x0a, 0x07, 0x48, 0x6f, 0x75, 0x73, 0x65, 0x49,
	0x44, 0x18, 0x01, 0x20, 0x03, 0x28, 0x05, 0x52, 0x07, 0x48, 0x6f, 0x75, 0x73, 0x65, 0x49, 0x44,
	0x42, 0x3f, 0x5a, 0x3d, 0x52, 0x65, 0x61, 0x63, 0x74, 0x69, 0x76, 0x65, 0x2d, 0x57, 0x65, 0x6c,
	...
	0x2f, 0x70, 0x72, 0x6f, 0x70, 0x65, 0x72, 0x74, 0x79, 0x4d, 0x65, 0x73, 0x73, 0x61, 0x67, 0x65,
...
var file_Reactive_Welfare_Housing_System_src_messages_property_proto_msgTypes = make([]protoimpl.MessageInfo, 1)
var file_Reactive_Welfare_Housing_System_src_messages_property_proto_goTypes = []interface{}{
	(*UnqualifiedHouseIDs)(nil), // 0: property.UnqualifiedHouseIDs
}
...
func file_Reactive_Welfare_Housing_System_src_messages_property_proto_init() {
	...
	if !protoimpl.UnsafeEnabled {
		file_Reactive_Welfare_Housing_System_src_messages_property_proto_msgTypes[0].Exporter = func(v interface{}, i int) interface{} {
			switch v := v.(*UnqualifiedHouseIDs); i {
			case 0:
				return &v.state
			case 1:
				return &v.sizeCache
